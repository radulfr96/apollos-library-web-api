...
namespace ApollosLibrary.Domain.Migrations
{
    ...
    [Migration("20220724061255_AddedBudgetSettings")]
    partial class AddedBudgetSettings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApollosLibrary.Domain.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionId = new Guid("52c1a824-a3fa-428f-a433-2290b15db9e0"),
                            ExpiryDate = new NodaTime.LocalDateTime(2032, 7, 21, 6, 12, 50).PlusNanoseconds(848929100L),
                            SubscriptionAdmin = new Guid("00000000-0000-0000-0000-000000000000"),
                            SubscriptionDate = new NodaTime.LocalDateTime(2022, 7, 24, 6, 12, 50).PlusNanoseconds(848929100L),
            ...
            modelBuilder.Entity("ApollosLibrary.Domain.UserBudgetSetting", b =>
                {
                    b.Property<int>("UserBudgetSettingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("UserBudgetSettingId"));
                    ...
                    b.HasKey("UserBudgetSettingId");

                    b.ToTable("UserBudgetSettings");
                });
