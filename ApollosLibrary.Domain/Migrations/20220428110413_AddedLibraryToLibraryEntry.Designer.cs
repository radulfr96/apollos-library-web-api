...
namespace ApollosLibrary.Domain.Migrations
{
    ...
    [Migration("20220428110413_AddedLibraryToLibraryEntry")]
    partial class AddedLibraryToLibraryEntry
    {
            ...
            modelBuilder.Entity("ApollosLibrary.Domain.Model.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionId = new Guid("cab27a35-aeed-429d-a8dd-281129113892"),
                            ExpiryDate = new DateTime(2102, 4, 28, 21, 4, 12, 320, DateTimeKind.Local).AddTicks(368),
                            JoinDate = new DateTime(2022, 4, 28, 21, 4, 12, 320, DateTimeKind.Local).AddTicks(427),
