...
namespace ApollosLibrary.Domain.Migrations
{
    ...
    [Migration("20220618083746_AddedVersionFields")]
    partial class AddedVersionFields
    {
            ...
            modelBuilder.Entity("ApollosLibrary.Domain.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionId = new Guid("48dddd49-b15e-4882-ade7-9617a82ad070"),
                            ExpiryDate = new DateTime(2102, 6, 18, 18, 37, 40, 761, DateTimeKind.Local).AddTicks(7841),
                            SubscriptionAdmin = new Guid("00000000-0000-0000-0000-000000000000"),
                            SubscriptionDate = new DateTime(2022, 6, 18, 18, 37, 40, 761, DateTimeKind.Local).AddTicks(7872),
