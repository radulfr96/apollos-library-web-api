...
namespace ApollosLibrary.Domain.Migrations
{
    ...
    [Migration("20220604102144_AddedStripeCustomerId")]
    partial class AddedStripeCustomerId
    {
            ...
            modelBuilder.Entity("ApollosLibrary.Domain.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionId = new Guid("93d25dcf-df84-4fdd-bfc5-99269e4d4ed5"),
                            ExpiryDate = new DateTime(2102, 6, 4, 20, 21, 15, 936, DateTimeKind.Local).AddTicks(9057),
                            SubscriptionAdmin = new Guid("00000000-0000-0000-0000-000000000000"),
                            SubscriptionDate = new DateTime(2022, 6, 4, 20, 21, 15, 936, DateTimeKind.Local).AddTicks(9092),
