...
namespace ApollosLibrary.Domain.Migrations
{
    ...
    [Migration("20220514075639_MissingOrderConnection")]
    partial class MissingOrderConnection
    {
            ...
            modelBuilder.Entity("ApollosLibrary.Domain.Model.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionId = new Guid("e3cf74b3-99ba-428b-8d25-f95fbbca407c"),
                            ExpiryDate = new DateTime(2102, 5, 14, 17, 56, 38, 762, DateTimeKind.Local).AddTicks(532),
                            JoinDate = new DateTime(2022, 5, 14, 17, 56, 38, 762, DateTimeKind.Local).AddTicks(568),
