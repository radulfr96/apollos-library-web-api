...
namespace ApollosLibrary.Domain.Migrations
{
    ...
    [Migration("20220610101605_AddedCreatedFieldsToReports")]
    partial class AddedCreatedFieldsToReports
    {
            ...
            modelBuilder.Entity("ApollosLibrary.Domain.Subscription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SubscriptionId = new Guid("52b2daef-f937-435a-a06c-dc1c102a1924"),
                            ExpiryDate = new DateTime(2102, 6, 10, 20, 16, 1, 140, DateTimeKind.Local).AddTicks(9294),
                            SubscriptionAdmin = new Guid("00000000-0000-0000-0000-000000000000"),
                            SubscriptionDate = new DateTime(2022, 6, 10, 20, 16, 1, 140, DateTimeKind.Local).AddTicks(9323),
